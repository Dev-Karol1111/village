...
func _on_texture_button_pressed() -> void:
	edit_menu.set_block(data.game_texture_tileset_x, data.game_texture_tileset_y, 0 ,data.price, load("res://Builds/buildsList.tres").get(data.type).find(data), data.type)
